...
# données Arches
identifiants_features <- read.csv(file = "EAMENA_2021-09-20_14-04-49.csv") %>%
  as_tibble()

identifiants_photos_sketches <- read.csv(file = "EAMENA_2021-09-20_14-10-48.csv") %>%
  as_tibble()
...
openxlsx::write.xlsx(relations_photos_liste,
                     "UCOP_relations_photos_features_places_bulk_4_Arches_ID.xlsx",
                     append = TRUE)
