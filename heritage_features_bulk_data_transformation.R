...
heritage_features_polygons_gis <- st_read("sorties/finales/500_features_bulk_2/donnees_spatiales_features.gpkg", layer = "polygons")

heritage_features_lines_gis <- st_read("sorties/finales/500_features_bulk_2/donnees_spatiales_features.gpkg", layer = "lines")

heritage_features_points_gis <- st_read("sorties/finales/500_features_bulk_2/donnees_spatiales_features.gpkg", layer = "points")
...
# à faire > change_date(x = sortie_zzAssessment, variable_date = sortie_zzAssessment$ASSESSMENT_ACTIVITY_DATE.E49)
...
write.xlsx(list_of_datasets, file = "sorties/finales/500_features_bulk_2/UCOP_heritage_features_bulk_lines.xlsx", append = TRUE)
...
write.xlsx(list_of_datasets, file = "sorties/finales/500_features_bulk_1/UCOP_heritage_features_bulk_points.xlsx", append = TRUE)
