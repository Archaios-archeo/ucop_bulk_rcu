...
sortie_NOT <- data_pivot %>%
  ...
  repetition_pattern_n_exact(x = ., 
                             ...
                             variable_revue = "HERITAGE_CLASSIFICATION_TYPE.E55") %>%
  repetition_pattern_n_exact(x = ., 
                             variable_a_bon_pattern = "GRID_ID.E42", 
                             variable_revue = "HERITAGE_FEATURE_USE_TYPE.E55") %>%
  repetition_pattern_n_exact(x = ., 
                             variable_a_bon_pattern = "GRID_ID.E42", 
...
write.xlsx(list_of_datasets, file = "sorties/finales/500_features_bulk_1/UCOP_heritage_features_bulk_v1.xlsx", append = TRUE)
...
write.xlsx(list_of_datasets, file = "sorties/finales/500_features_bulk_1/UCOP_heritage_features_bulk_lines.xlsx", append = TRUE)
