...
# specific directory
working_directory_photo <- paste0(working_directory, "/data/photos/features_places_bulk_12/")
...
working_directory_photo <- paste0(working_directory, "/sorties/finales/500_features_bulk_12/photos/")
...
openxlsx::write.xlsx(tableau_des_relations_photos_feature_hp, 
                     "sorties/finales/500_features_bulk_12/UCOP_relations_photos_features_places.xlsx")
...
openxlsx::write.xlsx(list_of_datasets, 
           file = "sorties/finales/500_features_bulk_12/UCOP_ressources_photos.xlsx")
